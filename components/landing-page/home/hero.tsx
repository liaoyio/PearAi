  ...
  return (
    <>
      <section className="relative">
        {/* Background Dots */}
        <div className="bg-dot-light-black dark:bg-dot-dark-black absolute inset-0 mx-auto max-w-7xl [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] lg:[mask-image:radial-gradient(ellipse_at_left,transparent_20%,black)]"></div>
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="relative my-20 flex max-w-6xl flex-col items-center px-6 lg:items-start">
            ...
            >
              <div className="text-white-50 h-4 w-4 rounded-sm bg-[#f26625] text-center font-mono text-xs font-medium sm:h-5 sm:w-5 sm:rounded-md sm:text-sm">
                Y
              </div>
              <a
              ...
              >
                BACKED BY Y COMBINATOR <ChevronRightIcon className="h-3 w-3" strokeWidth={3} />
              </a>
            </motion.div>
            ...
            >
              <p className="text-base text-black/60 dark:text-gray-500 sm:text-lg">
                Supercharge your development with an up-to-date, curated inventory of the best AI
                tools, natively integrated for effortless AI-powered coding.
              </p>
            </motion.div>
