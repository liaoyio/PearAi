import { Aider, Perplexity, Supermaven, Mem0, Continue } from '@/assets/icons';
...
const IntegrationItem = ({ margin, label, product, Icon }: IntegrationItemProps) => (
  <div
    className={`bg-white dark:bg-gray-800 ${margin} w-fit rounded-lg border border-gray-200 px-3 py-2 dark:border-black/50`}
  >
    <div className="flex items-center gap-2">
      <Icon className="h-8 w-8" />
      <div className="flex flex-col text-xs">
        <span className="text-gray-400 dark:text-gray-500">{label}</span>
        <span className="font-medium dark:text-white [&>*]:text-black/60">
          {product}
          <sup>*</sup>
        </span>
      </div>
    ...
    <>
      ...
      <div className="hidden lg:block">
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop stopColor="currentColor" offset="0.893735" stopOpacity="0.5" />
              </radialGradient>
            </defs>
          </svg>
        </div>
        ...
        <div className="absolute right-56 top-24 flex flex-col gap-10">
          ...
          {/* Bottom Card */}
          <div
            className={`bg-white-50 -ml-[78px] mt-16 w-fit rounded-lg border border-gray-200 px-3 py-2 dark:border-black/50 dark:bg-gray-800`}
          >
            <div className="flex items-center gap-2">
              <div className="text-white-50 bg-primary-700 shadow-primary-700/50 flex h-7 w-7 items-center justify-center rounded-sm text-xs font-bold shadow-[0_0_12px_1px]">
                V1
              </div>
              <div className="flex flex-col text-xs">
                <span className="text-gray-500 dark:text-gray-400">11/12 Launch</span>
                <span className="font-medium text-black/60">More coming soon</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="block w-full lg:hidden">
        <div className="relative mx-auto max-w-sm">
          ...
          <div className="absolute inset-0 flex scale-110 items-center justify-center">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="currentColor" stopOpacity="0.2" />
                  <stop offset="0.893735" stopColor="currentColor" stopOpacity="0" />
                </radialGradient>
              </defs>
            </svg>
          </div>
          ...
          <div className="mt-20 flex w-full translate-y-2 justify-center">
            <div className="bg-white-50 w-fit rounded-lg border border-gray-200 px-3 py-2 dark:border-black/50 dark:bg-gray-800">
              <div className="flex items-center gap-2">
                <div className="text-white-50 bg-primary-700 shadow-primary-700/50 flex h-7 w-7 items-center justify-center rounded-sm text-xs font-bold shadow-[0_0_12px_1px]">
                  V1
                </div>
                <div className="flex flex-col text-xs">
                  <span className="text-gray-500 dark:text-gray-400">11/12 Launch</span>
                  <span className="font-medium text-black/60 dark:text-white">
                    More coming soon
                  </span>
                </div>
              </div>
